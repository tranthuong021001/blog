...
<html class="no-js" lang="zxx">
    <head>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" type="image/x-icon" href="{{url('/frontend2/img/favicon.png')}}">

		<!-- all css here -->
        <link rel="stylesheet" href="{{url('/frontend2/css/bootstrap.min.css')}}">
        <link rel="stylesheet" href="{{url('/frontend2/css/plugin.css')}}">
        <link rel="stylesheet" href="{{url('/frontend2/css/bundle.css')}}">
        <link rel="stylesheet" href="{{url('/frontend2/css/style.css')}}">
        <link rel="stylesheet" href="{{url('/frontend2/css/responsive.css')}}">
        <script src="{{url('/frontend2/js/vendor/modernizr-2.8.3.min.js')}}"></script>
    </head>
    <body>
                                ...
                                <div class="header_top">
                                   <div class="row align-items-center">
                                        <div class="col-lg-6 col-md-6">
                                           <div class="switcher">
                                                <ul>
                                                    <li class="languages"><a href="#"><img src="{{url('/frontend2/img/logo/fontlogo.jpg')}}" alt=""> English <i class="fa fa-angle-down"></i></a>
                                                        <ul class="dropdown_languages">
                                                            <li><a href="#"><img src="{{url('/frontend2/img/logo/fontlogo.jpg')}}" alt=""> English</a></li>
                                                            <li><a href="#"><img src="{{url('/frontend2/img/logo/fontlogo2.jpg')}}" alt=""> French </a></li>
                                                        </ul>
                                                    </li>
                                    ...
                                    <div class="row align-items-center">
                                       <!--logo start-->
                                        <div class="col-lg-3 col-md-3">
                                            <div class="logo">
                                                <a href="index.html"><img src="{{url('/frontend2/img/logo/logo.jpg.png')}}" alt=""></a>
                                            </div>
                                        </div>
                                        <!--logo end-->
                                            ...
                                            <div class="header_right_info">
                                                ...
                                                <div class="shopping_cart">
                                                    ...
                                                    <div class="mini_cart">
                                                        <div class="cart_item">
                                                           <div class="cart_img">
                                                               <a href="#"><img src="{{url('/frontend2/img/cart/cart.jpg')}}" alt=""></a>
                                                           </div>
                                                            <div class="cart_info">
                                                        ...
                                                        <div class="cart_item">
                                                           <div class="cart_img">
                                                               <a href="#"><img src="{{url('/frontend2/img/cart/cart2.jpg')}}" alt=""></a>
                                                           </div>
                                                            <div class="cart_info">
                                                                ...
                                                                <div class="mega_menu">
                                                                    ...
                                                                    <div class="mega_bottom fix">
                                                                        <div class="mega_thumb">
                                                                            <a href="#"><img src="{{url('/frontend2/img/banner/banner1.jpg')}}" alt=""></a>
                                                                        </div>
                                                                        <div class="mega_thumb">
                                                                            <a href="#"><img src="{{url('/frontend2/img/banner/banner2.jpg')}}" alt=""></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li><a href="#">men</a>
                                                                <div class="mega_menu">
                                                                    <div class="mega_top fix">
                                                                        ...
                                                                        <div class="mega_items">
                                                                            <a href="#"><img src="{{url('/frontend2/img/banner/banner3.jpg')}}" alt=""></a>
                                                                        </div>
                                                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="banner_slider slider_two">
                                        <div class="slider_active owl-carousel">
                                            <div class="single_slider" style="background-image: url(/frontend2/img/slider/slider_2.png)">
                                            ...
                                            <div class="single_slider" style="background-image: url(/frontend2/img/slider/slide_4.png)">
                                                 <div class="slider_content">
                                                    <div class="slider_content_inner">
                                                        <h1>fashion for you</h1>
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br> Cumque eligendi quia, ratione porro, nemo non.</p>
                                            ...
                                            <div class="single_slider" style="background-image: url(/frontend2/img/slider/slider_3.png)">
                                                 <div class="slider_content">
                                                    <div class="slider_content_inner">
                                                        <h1>fashion for you</h1>
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br> Cumque eligendi quia, ratione porro, nemo non.</p>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="single_product">
                                                <div class="product_thumb">
                                                   <a href="single-product.html"><img src="{{url('/frontend2/img/product/product1.jpg')}}" alt=""></a>
                                                   <div class="img_icone">
                                                       <img src="{{url('/frontend2/img/cart/span-new.png')}}" alt="">
                                                   </div>
		...
		<!-- all js here -->
        <script src="{{url('/frontend2/js/vendor/jquery-1.12.0.min.js')}}"></script>
        <script src="{{url('/frontend2/js/popper.js')}}"></script>
        <script src="{{url('/frontend2/js/bootstrap.min.js')}}"></script>
        <script src="{{url('/frontend2/js/ajax-mail.js')}}"></script>
        <script src="{{url('/frontend2/js/plugins.js')}}"></script>
        <script src="{{url('/frontend2/js/main.js')}}"></script>
    </body>
</html>
