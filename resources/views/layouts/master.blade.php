...
<head>
	...
	<!-- Nice Select CSS -->
    <link rel="stylesheet" href="{{url('/frontend/css/niceselect.css')}}">
	<!-- Animate CSS -->
    <link rel="stylesheet" href="{{url('/frontend/css/animate.css')}}">
	<!-- Flex Slider CSS -->
    <link rel="stylesheet" href="{{url('/frontend/css/flex-slider.min.css')}}">
	<!-- Owl Carousel -->
				...
				<div class="row">
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="single-footer about">
							<div class="logo">
								<a href="index.html"><img src="{{url('/frontend/images/logo2.png')}}" alt="#"></a>
							</div>
			...
			<div class="container">
				<div class="inner">
					<div class="row">
						...
						<div class="col-lg-6 col-12">
							<div class="right">
								<img src="{{url('/frontend/images/payments.png')}}" alt="#">
							</div>
						</div>
					</div>
				</div>
